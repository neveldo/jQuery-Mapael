 ...
 *
 * Added support for animated zoom with defined duration
 *
 */
(function($) {
		...
		$.fn.mapael = function(options) {
				...
				return this.each(function() {
						...
						$self.on("zoom", function(e, zoomOptions) {
								...
								if (newLevel == 0) {
										if(zoomOptions.animate > 0){
												$.fn.mapael.animateViewBox(paper, panX, panY, mapConf.width, mapConf.height, zoomOptions.animate, "<>", function(){});
										}
										else {
										...
										if(zoomOptions.animate > 0){
												$.fn.mapael.animateViewBox(paper, panX, panY, (mapConf.width / zoomLevel), (mapConf.height / zoomLevel), zoomOptions.animate, "<>", function(){});
										}
										else {
		...
		/**
		 * Add support for animated view box changes
		 * As from http://stackoverflow.com/a/13371825
		 * @param paper paper Raphael paper object
		 ...
		 */
		$.fn.mapael.animateViewBox = function (paper, x, y, w, h, duration, easing_function, callback )
		{
